...
export class ProcessingHelper {
  ...
  private async initializeAIClient(): Promise<void> {
    try {
      ...
      const validation = await provider.validateApiKey(config.apiKey);
      if (!validation.valid) {
      ...
      this.currentClient = await provider.getClient(config.apiKey);
  ...
  private async processScreenshotsHelper(
    ...
    try {
      ...
      const problemInfo = await provider.extractProblemInfo({
